...
unrealRootPath=/home/grey/UE5
BuildingEscapeRootPath=/home/grey/repos/BuildingEscape/BuildingEscape

gameProjectFile=/home/grey/repos/BuildingEscape/BuildingEscape/BuildingEscape.uproject
...
EpicWebHelper-Linux-Debug.commands = $$build EpicWebHelper Linux Debug  -project="\"$$gameProjectFile\"" $$args
EpicWebHelper-Linux-DebugGame.commands = $$build EpicWebHelper Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
EpicWebHelper-Linux-Shipping.commands = $$build EpicWebHelper Linux Shipping  -project="\"$$gameProjectFile\"" $$args
EpicWebHelper-Linux-Test.commands = $$build EpicWebHelper Linux Test  -project="\"$$gameProjectFile\"" $$args
EpicWebHelper.commands = $$build EpicWebHelper Linux Development  -project="\"$$gameProjectFile\"" $$args
...
InterchangeWorker-Linux-Debug.commands = $$build InterchangeWorker Linux Debug  -project="\"$$gameProjectFile\"" $$args
InterchangeWorker-Linux-DebugGame.commands = $$build InterchangeWorker Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
InterchangeWorker-Linux-Shipping.commands = $$build InterchangeWorker Linux Shipping  -project="\"$$gameProjectFile\"" $$args
InterchangeWorker-Linux-Test.commands = $$build InterchangeWorker Linux Test  -project="\"$$gameProjectFile\"" $$args
InterchangeWorker.commands = $$build InterchangeWorker Linux Development  -project="\"$$gameProjectFile\"" $$args
...
UnrealObjectPtrTool-Linux-Debug.commands = $$build UnrealObjectPtrTool Linux Debug  -project="\"$$gameProjectFile\"" $$args
UnrealObjectPtrTool-Linux-DebugGame.commands = $$build UnrealObjectPtrTool Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
UnrealObjectPtrTool-Linux-Shipping.commands = $$build UnrealObjectPtrTool Linux Shipping  -project="\"$$gameProjectFile\"" $$args
UnrealObjectPtrTool-Linux-Test.commands = $$build UnrealObjectPtrTool Linux Test  -project="\"$$gameProjectFile\"" $$args
UnrealObjectPtrTool.commands = $$build UnrealObjectPtrTool Linux Development  -project="\"$$gameProjectFile\"" $$args
...
TextureShareSDK_D3D11-Linux-Debug.commands = $$build TextureShareSDK_D3D11 Linux Debug  -project="\"$$gameProjectFile\"" $$args
TextureShareSDK_D3D11-Linux-DebugGame.commands = $$build TextureShareSDK_D3D11 Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
TextureShareSDK_D3D11-Linux-Shipping.commands = $$build TextureShareSDK_D3D11 Linux Shipping  -project="\"$$gameProjectFile\"" $$args
TextureShareSDK_D3D11-Linux-Test.commands = $$build TextureShareSDK_D3D11 Linux Test  -project="\"$$gameProjectFile\"" $$args
TextureShareSDK_D3D11.commands = $$build TextureShareSDK_D3D11 Linux Development  -project="\"$$gameProjectFile\"" $$args

TextureShareSDK_D3D12-Linux-Debug.commands = $$build TextureShareSDK_D3D12 Linux Debug  -project="\"$$gameProjectFile\"" $$args
TextureShareSDK_D3D12-Linux-DebugGame.commands = $$build TextureShareSDK_D3D12 Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
TextureShareSDK_D3D12-Linux-Shipping.commands = $$build TextureShareSDK_D3D12 Linux Shipping  -project="\"$$gameProjectFile\"" $$args
TextureShareSDK_D3D12-Linux-Test.commands = $$build TextureShareSDK_D3D12 Linux Test  -project="\"$$gameProjectFile\"" $$args
TextureShareSDK_D3D12.commands = $$build TextureShareSDK_D3D12 Linux Development  -project="\"$$gameProjectFile\"" $$args
...
UnrealClient-Linux-Debug.commands = $$build UnrealClient Linux Debug  -project="\"$$gameProjectFile\"" $$args
UnrealClient-Linux-DebugGame.commands = $$build UnrealClient Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
UnrealClient-Linux-Shipping.commands = $$build UnrealClient Linux Shipping  -project="\"$$gameProjectFile\"" $$args
UnrealClient-Linux-Test.commands = $$build UnrealClient Linux Test  -project="\"$$gameProjectFile\"" $$args
UnrealClient.commands = $$build UnrealClient Linux Development  -project="\"$$gameProjectFile\"" $$args

UnrealEditor-Linux-Debug.commands = $$build UnrealEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
UnrealEditor-Linux-DebugGame.commands = $$build UnrealEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
UnrealEditor-Linux-Shipping.commands = $$build UnrealEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
UnrealEditor-Linux-Test.commands = $$build UnrealEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
UnrealEditor.commands = $$build UnrealEditor Linux Development  -project="\"$$gameProjectFile\"" $$args

UnrealGame-Linux-Debug.commands = $$build UnrealGame Linux Debug  -project="\"$$gameProjectFile\"" $$args
UnrealGame-Linux-DebugGame.commands = $$build UnrealGame Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
UnrealGame-Linux-Shipping.commands = $$build UnrealGame Linux Shipping  -project="\"$$gameProjectFile\"" $$args
UnrealGame-Linux-Test.commands = $$build UnrealGame Linux Test  -project="\"$$gameProjectFile\"" $$args
UnrealGame.commands = $$build UnrealGame Linux Development  -project="\"$$gameProjectFile\"" $$args

UnrealServer-Linux-Debug.commands = $$build UnrealServer Linux Debug  -project="\"$$gameProjectFile\"" $$args
UnrealServer-Linux-DebugGame.commands = $$build UnrealServer Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
UnrealServer-Linux-Shipping.commands = $$build UnrealServer Linux Shipping  -project="\"$$gameProjectFile\"" $$args
UnrealServer-Linux-Test.commands = $$build UnrealServer Linux Test  -project="\"$$gameProjectFile\"" $$args
UnrealServer.commands = $$build UnrealServer Linux Development  -project="\"$$gameProjectFile\"" $$args
